import { Blocks, Code2, Sparkles, LogOut } from "lucide-react";
import { Link } from "react-router-dom";

export const SnippetNavbar = () => {
  return (
    <div className="sticky top-0 z-50 mb-6 w-full border-b border-gray-800/50 bg-gray-950/80 backdrop-blur-xl backdrop-saturate-150">
